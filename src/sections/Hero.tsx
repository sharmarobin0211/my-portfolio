      ...
      <div className="container">
        ...
        <div className="max-w-lg mx-auto">
          ...
          <p className="mt-4 text-center text-white/60 md:text-lg">
            I specialize in automating deployments, optimizing cloud infrastructure,
            and building robust backend systems that scale efficiently in production environments.
            Bridging the gap between development and DevOps culture, I deliver
            solutions with a focus on performance and reliability.
          </p>
        </div>
